...
- New helpers: `matchLocaleFromRequest`, `matchLocaleFromUrl`, `getSupportedLocales`, `getLocalizedHref` (rewrites an href into another locale; a path under pathname routing, an absolute URL under domain routing), and `isSameLocale`.
