...
type ProductData = Awaited<ReturnType<typeof loader>>["product"];
  ...
  return (
    <ProductProvider
      ...
      onSelect={(result) => {
        void navigate(
          getVariantUrl({
            handle: result.selectedVariant?.product?.handle ?? product.handle,
            optionNames: product.options.map(
              (option: ProductData["options"][number]) => option.name,
            ),
...
function ProductDetails() {
  ...
  const analyticsVariant = selectedVariant ?? product.selectedOrFirstAvailableVariant;

  return (
    <div className="product">
      <ProductImage image={selectedVariant?.image ?? null} />
