...
test.describe("Markets Recipe", () => {
  ...
  test.describe("FR-CA Cart Flow", () => {
    test("locale prefix persists through cart flow and cart shows CAD prices", async ({ page }) => {
      const recipe = new MarketsUtil(page);
  ...
  test.describe("Country Selector", () => {
    ...
    test("displays current locale and switches locale on selection", async ({ page }) => {
      const recipe = new MarketsUtil(page);
