...
| `/collections/:handle` | `examples/core/reference/collection.html` | Live: queries `collection(handle:)` with up to 24 products |
| `/products/:handle` | `examples/core/reference/product.html` | Live: gallery, options (Size + Color swatches), add-to-cart UI; "You may also like" pulls from `products(first: 4)` |
