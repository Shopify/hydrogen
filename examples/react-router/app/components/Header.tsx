    ...
    <header className="border-b border-black/10">
      <div className="mx-auto grid h-16 max-w-[1480px] grid-cols-3 items-center px-6">
        <nav className="flex items-center gap-6 text-sm font-semibold">
          ...
          <Link to="/blogs/news" className="hover:opacity-60">
            News
          </Link>
        </nav>
        <Link to="/" className="justify-self-center text-lg font-black tracking-tight">
          MOCK.SHOP
        </Link>
        <div className="flex items-center justify-end gap-5">
          ...
          <Link to="/" aria-label="Account" className="hover:opacity-60">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          {hasHydrated ? (
            ...
            <Link to="/cart" aria-label={cartLabel} className="relative hover:opacity-60">
              <CartIcon />
              {cartBadge}
            </Link>
          )}
