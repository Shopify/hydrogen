...
| Route | Source | Status |
|---|---|---|
| `/` | `examples/core/reference/home.html` | Live: hero is static; featured products grid pulls from `products(first: 3)` |
| `/collections` | `examples/core/reference/collections.html` | Live: queries `collections(first: 12)` |
| `/collections/:handle` | `examples/core/reference/collection.html` | Live: queries `collection(handle:)` with up to 24 products, URL-synced filters, sort, and active filter chips |
| `/products/:handle` | `examples/core/reference/product.html` | Live: gallery, URL-synced variant options, add-to-cart, Shop Pay, and related products |
