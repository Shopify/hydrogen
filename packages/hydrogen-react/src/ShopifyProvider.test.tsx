...
describe('<ShopifyProvider/>', () => {
  ...
  describe(`getStorefrontApiUrl()`, () => {
    it(`returns the correct values`, () => {
      ...
      expect(result.current.getStorefrontApiUrl()).toBe(
        'https://notashop.myshopify.com/api/2025-04/graphql.json',
      );
    });
  ...
  describe(`getStorefrontApiUrl`, () => {
    ...
    it(`allows overrides`, () => {
      ...
      ).toBe('https://test.myshopify.com/api/2025-04/graphql.json');
    });
...
export function getShopifyConfig(
  ...
  return {
    ...
    storefrontApiVersion: config.storefrontApiVersion ?? '2025-04',
  };
}
