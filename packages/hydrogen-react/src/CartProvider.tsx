...
type CartProviderProps = {
  ...
  /** An object with fields that correspond to the Storefront API's [Cart object](https://shopify.dev/api/storefront/storefront/2023-04/objects/cart). */
  data?: PartialDeep<CartType, {recurseIntoArrays: true}>;
  /** A fragment used to query the Storefront API's [Cart object](https://shopify.dev/api/storefront/storefront/2023-04/objects/cart) for all queries and mutations. A default value is used if no argument is provided. */
  cartFragment?: string;
