...
export function CartProvider({
  ...
  const cartContextValue = useMemo<CartWithActions>(() => {
    return {
      ...
      userErrors: cartDisplayState?.context?.userErrors,
      warnings: cartDisplayState?.context?.warnings,
    ...
    cartDisplayState?.context?.userErrors,
    cartDisplayState?.context?.warnings,
