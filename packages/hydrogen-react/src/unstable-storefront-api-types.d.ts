 ...
 * Based on Storefront API unstable
...
export type PaginatedSitemapResources = {
   ...
   *
   */
  items: Array<SitemapResourceBase | SitemapResourceMetaobject>;
};
...
export type Product = HasGates &
  ...
  Trackable & {
    ...
    /**
     * The first variant that is available for sale.
     *
     */
...
/** Represents a metaobject sitemap resource. */
