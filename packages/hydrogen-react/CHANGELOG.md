...
- New export `getTrackingValues` to obtain information for analytics and marketing. Use this instead of `getShopifyCookies` (which is now deprecated). ([#3332](https://github.com/Shopify/hydrogen/pull/3332)) by [@kdaviduik](https://github.com/kdaviduik)
