...
- Support Shopify's new consolidated cookie architecture. Adds built-in Storefront API proxy support to `createRequestHandler`. ([#3354](https://github.com/Shopify/hydrogen/pull/3354)) by [@kdaviduik](https://github.com/kdaviduik)
