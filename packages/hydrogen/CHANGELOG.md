...
- This version adds support for the new cookie system in Shopify (`_shopify_analytics` and `_shopify_marketing` http-only cookies). It is backward compatible and still supports the deprecated `_shopify_y` and `_shopify_s` cookies. ([#3332](https://github.com/Shopify/hydrogen/pull/3332)) by [@kdaviduik](https://github.com/kdaviduik)
...
- Fixed a number of issues related to irregular behaviors between Privacy Banner and Hydrogen's analytics events. ([#3332](https://github.com/Shopify/hydrogen/pull/3332)) by [@kdaviduik](https://github.com/kdaviduik)

- Updated dependencies [[`24664db0`](https://github.com/Shopify/hydrogen/commit/24664db0144eb8a78b8060da80b7dafc4b1a4b41)]:
