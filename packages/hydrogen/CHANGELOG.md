...
- Add React Router 7.8.x support infrastructure with full compatibility for both context access patterns. ([#3142](https://github.com/Shopify/hydrogen/pull/3142)) by [@juanpprieto](https://github.com/juanpprieto)
...
- Migrate skeleton template to React Router 7.8.x ([#3141](https://github.com/Shopify/hydrogen/pull/3141)) by [@juanpprieto](https://github.com/juanpprieto)
