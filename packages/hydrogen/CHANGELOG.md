...
- Add `locale` parameter to Customer Account login ([#3377](https://github.com/Shopify/hydrogen/pull/3377)) by [@lihaokx](https://github.com/lihaokx)
...
- Add `loginHintMode` parameter to Customer Account login ([#3364](https://github.com/Shopify/hydrogen/pull/3364)) by [@lihaokx](https://github.com/lihaokx)
...
- Updated dependencies [[`19215e6b7a0fc49872a5fa018cbb071813007cd9`](https://github.com/Shopify/hydrogen/commit/19215e6b7a0fc49872a5fa018cbb071813007cd9)]:
