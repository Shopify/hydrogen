...
- This version adds support for the new cookie system in Shopify (`_shopify_analytics` and `_shopify_marketing` http-only cookies). It is backward compatible and still supports the deprecated `_shopify_y` and `_shopify_s` cookies. ([#3354](https://github.com/Shopify/hydrogen/pull/3354)) by [@kdaviduik](https://github.com/kdaviduik)
...
- Fixed a number of issues related to irregular behaviors between Privacy Banner and Hydrogen's analytics events. ([#3354](https://github.com/Shopify/hydrogen/pull/3354)) by [@kdaviduik](https://github.com/kdaviduik)

- Updated dependencies [[`f4250ab5`](https://github.com/Shopify/hydrogen/commit/f4250ab58565c21a6bb26b32062a382fef815fa6)]:
  - @shopify/hydrogen-react@2025.1.4
