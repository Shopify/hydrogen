...
export type CartAddressInput =
  ...
  | {
      copyFromCustomerAddressId: Scalars["ID"]["input"];
      deliveryAddress?: never;
    } /** A delivery address stored on this cart. */
  | { copyFromCustomerAddressId?: never; deliveryAddress: CartDeliveryAddressInput };
...
export type CartLineParentInput =
  ...
  | { lineId?: never; merchandiseId: Scalars["ID"]["input"] };
