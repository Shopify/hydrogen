...
export const storefrontContext = unstable_createContext<StorefrontClient<I18nBase>['storefront']>();
export const cartContext = unstable_createContext<HydrogenCart | HydrogenCartCustom<CustomMethodsBase>>();
