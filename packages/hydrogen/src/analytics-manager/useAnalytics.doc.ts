...
const data: ReferenceEntityTemplateSchema = {
  ...
  related: [],
  description:
    'A hook that provides access to the analytics provider context. Must be a descendent of [`Analytics.Provider`](/docs/api/hydrogen/components/Analytics-provider).',
  type: 'hook',
  defaultExample: {
