...
const data: ReferenceEntityTemplateSchema = {
  ...
  related: [],
  description:
    'Creates a function that accepts an object of [CartSelectedDeliveryOptionInput](/docs/api/storefront/2025-04/input-objects/CartSelectedDeliveryOptionInput) and updates the selected delivery option of a cart',
  type: 'utility',
  defaultExample: {
