...
const data: ReferenceEntityTemplateSchema = {
  ...
  related: [],
  description:
    'Creates a function that accepts an array of [CartSelectableAddressInput](/docs/api/storefront/2026-01/input-objects/CartSelectableAddressInput) to add to a cart',
  type: 'utility',
  defaultExample: {
