...
> = {
   ...
   * See the [example usage](/docs/api/hydrogen/current/utilities/createcarthandler#example-cart-fragments) in the documentation.
   */
  cartMutateFragment?: string;
  /**
   ...
   * See the [example usage](/docs/api/hydrogen/current/utilities/createcarthandler#example-custom-methods) in the documentation.
   */
  customMethods?: TCustomMethods;
};
