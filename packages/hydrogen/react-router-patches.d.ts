...
declare module '@shopify/hydrogen' {
  ...
  export interface PaginationProps<NodesType> {
    connection: {
      nodes: NodesType[];
      pageInfo: {
  ...
  export interface PaginationInfo<NodesType> {
    nodes: NodesType[];
    isLoading: boolean;
    PreviousLink: React.FC<Omit<LinkProps, 'to'> & RefAttributes<HTMLAnchorElement> & {children?: React.ReactNode}>;
    NextLink: React.FC<Omit<LinkProps, 'to'> & RefAttributes<HTMLAnchorElement> & {children?: React.ReactNode}>;
    state: any;
    nextPageUrl: string;
    hasNextPage: boolean;
  }
  
  export type PaginationRenderProp<NodesType> = (props: PaginationInfo<NodesType>) => React.ReactNode;
  
  export function Pagination<NodesType>(props: PaginationProps<NodesType>): React.ReactNode;
  
  // Fix Image component types
  export interface HydrogenImageProps {
    alt?: string;
    aspectRatio?: string;
    data: any;
    loading?: 'eager' | 'lazy';
