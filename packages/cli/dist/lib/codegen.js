...
async function generateTypes({
  ...
  const codeGenCLI = require2.resolve("@graphql-codegen/cli", {
...
async function generateDefaultConfig({
  ...
  const hydrogenPath = require2.resolve("@shopify/hydrogen-codegen", {
    paths: [rootDirectory]
  });
  ...
  const graphqlConfigPath = require2.resolve("graphql-config", {
    paths: [rootDirectory]
  });
