import {CacheShort, type CachingStrategy} from './strategies';
import {type CacheKey, runWithCache, type DebugOptions} from './run-with-cache';
import type {WaitUntil} from '../types';
import {parseJSON} from '../utils/parse-json';
import {createGraphQLClient} from '@shopify/graphql-client';

const STOREFRONT_API_TIMEOUT_IN_MS = 10_000;
        ...
        const client = createGraphQLClient({
          ...
          customFetchApi: async (
            ...
            rawResponse = await fetch(url, {
              ...options,
              signal: AbortSignal.timeout(STOREFRONT_API_TIMEOUT_IN_MS),
            });
