    ...
    runtime = new ModuleRunner(
          ...
          invoke: async (data) => {
            ...
            if (data.type === 'custom') {
              ...
              if (customData.name === 'getBuiltins') {
                // Return empty array as we don't have custom builtins
      ...
      },
      {
        ...
        async runInlinedModule(
          ...
          //
          // IMPORTANT: Parameter order must match Vite's esmEvaluator to ensure
          // compatibility with the transformed SSR code in Vite 7+
