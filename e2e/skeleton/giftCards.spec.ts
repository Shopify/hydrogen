...
test.beforeEach(async ({storefront, context}) => {
  ...
  // Navigate to cart and clear any existing gift cards from previous test runs
  // This ensures proper test isolation since gift cards are server-side state
...
test.describe('Gift Card Functionality', () => {
  ...
  test.describe('Edge Cases', () => {
    ...
    test('should not apply empty or whitespace-only code', async ({
      storefront,
    }) => {
      await storefront.tryApplyGiftCardCode('');
