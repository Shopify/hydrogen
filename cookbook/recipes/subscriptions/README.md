...
| File | Description |
| --- | --- |
| [`app/components/Cart.tsx`](ingredients/templates/skeleton/app/components/Cart.tsx) | Cart component to show subscription options |
...
| [`app/styles/selling-plan.css`](ingredients/templates/skeleton/app/styles/selling-plan.css) | CSS file for selling plan styles in the product page |
...
### 4. Add Selling Plan Data to Cart Queries
