...
((e) => {
  ...
  const w = e.parent,
    ...
    j = (e, t) => {
      let n,
        ...
        u = c + ':not([async]):not([defer])';
      l && l.body
        ? ((n = l.querySelector(u)),
          n || (n = l.querySelector(c)),
          n
  ...
  (async (e) => {
      ...
      if (0 === s) {
        const e = (() => {
          const e = S.createElement('i'),
            ...
            s = V(w, 'IntersectionObserver'),
            o = V(w, 'MutationObserver'),
            a = V(w, 'ResizeObserver'),
            l = w.performance,
            c = w.screen,
            u = [
              [w.history],
    ...
    e &&
      ...
      (G.onmessage = (t) => {
        const r = t.data;
        12 === r[0] ? U(G, r[1]) : e(G, r);
      }),
      w.addEventListener('pt1', (e) =>
        H(G, f(e.detail.frameElement), e.detail),
      ));
  });
})(window);
