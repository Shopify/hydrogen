...
export function MoreGridItems({
  ...
  cursor,
  pageBy = 4,
  placeholderItem = <div className="bg-gray-400 h-[244px] sm:h-[280px] md:h-[500px] lg:h-[300px] xl:h-[348px] 2xl:h-[500px]"></div>,
  setCursor,
  setHasNextPage,
  setItems,
  ...props
  ...
  const onPageLoadedMergeItems = useCallback(() => {
    ...
    const result = data?.collection?.products // /collection/$handle
