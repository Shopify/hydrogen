import {forwardRef, Suspense, useEffect, useId} from 'react';
import {
  useFetcher,
  useLocation,
  useMatches,
...
import {LINES_CART_FRAGMENT, USER_ERROR_FRAGMENT} from './LinesAdd';
...
export async function action({request, context, params}: ActionArgs) {
  ...
  return linesUpdateResponse(lines, cart, errors, formData);
}
...
*/
export const LinesUpdateForm = forwardRef(
  (
...
/*
  hooks ----------------------------------------------------------------
*/
export function useOptimisticLineUpdate(line?: CartLine) {
...
function linesUpdateResponse(
  ...
  const {linesUpdated, linesNotUpdated} = getLinesUpdated(prevLines, cart);
...
export async function linesUpdateMutation({
  cartId,
  lines,
  params,
  context,
