...
These PNGs are **fresh CORE reference render anchors** for the experiment
...
HTML in `experiments/core/reference/*.html` and the page checklists in
`experiments/core/notes/*.md`.
