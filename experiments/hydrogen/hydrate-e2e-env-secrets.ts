...
const HYDROGEN_ROOT = "experiments/hydrogen";
const SHARED_EJSON_FILE = "experiments/shared/secrets.ejson";
const HYDROGEN_EJSON_FILE = "experiments/hydrogen/secrets.ejson";
const SOURCE_E2E_ENVS_DIR = "experiments/hydrogen/e2e/envs";
