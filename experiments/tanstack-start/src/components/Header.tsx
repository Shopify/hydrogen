...
import { PredictiveSearchTrigger } from "./PredictiveSearch";
    ...
    <header className="border-border bg-surface sticky top-0 z-40 border-b">
      ...
      >
        ...
        <div className="flex items-center gap-0">
          ...
          {/* Always links to /account: reading session state here would mark
              every document personalized and make the whole site uncacheable.
              The account page renders the login CTA when logged out. */}
          <Link
            to="/account"
