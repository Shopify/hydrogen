# Rule: Updating an Existing Task List from a PRD
...
1. **Analyse Inputs** – Read PRD, current task list, and change request; compare to spot additions, modifications, or removals.
