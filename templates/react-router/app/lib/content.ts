...
export const content = {
  ...
  collection: {
    ...
    loadingPrevious: "Loading previous products...",
    loadMore: "Load more",
    loadingMore: "Loading more products...",
    paginationError: "More products could not be loaded. Please try again.",
    showingCount: "Showing {{ shown }} of {{ total }} products",
    showingCountPartial: "Showing {{ shown }} products",
    updatingCounts: "Updating product and filter counts...",
