 ...
 *
 * The inner content suspends on the deferred cart seed so server HTML and
 * hydration render from the same resolved cart.
 */
export function CartDrawer() {
  ...
  return (
    ...
    >
      <Suspense
        fallback={
          <p role="status" className="text-on-surface-secondary p-4 text-sm">
            Loading cart…
          </p>
        }
      >
