  ...
  return (
    ...
    >
      ...
      <p className="type-body text-on-surface-secondary mt-3 max-w-xl">
        This template is running against mock.shop or is missing Customer Account environment
        variables. Set a real store token plus Customer Account config to enable login:
      </p>
      <ul className="type-body-sm text-on-surface-secondary mt-4 list-disc ps-6">
        ...
        <li>
          <code className="bg-surface-secondary rounded-sm px-1.5 py-0.5">
            SHOP_ID, PUBLIC_CUSTOMER_ACCOUNT_API_CLIENT_ID, CUSTOMER_ACCOUNT_SESSION_SECRET
          </code>
        </li>
      </ul>
    </section>
