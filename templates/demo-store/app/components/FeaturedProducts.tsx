 ...
 * @see query https://shopify.dev/api/storefront/2024-01/queries/products
 * @see filters https://shopify.dev/api/storefront/2024-01/queries/products#argument-products-query
 */
