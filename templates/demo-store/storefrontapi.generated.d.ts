...
> & {
  currentTotalPrice: Pick<MoneyV2, 'amount' | 'currencyCode'>;
  lineItems: {
    edges: Array<{
      node: Pick<OrderLineItem, 'title'> & {
        variant?: Maybe<{
          image?: Maybe<Pick<Image, 'url' | 'altText' | 'height' | 'width'>>;
        }>;
      };
    }>;
  };
...
> & {
    image?: Maybe<Pick<Image, 'id' | 'url' | 'width' | 'height'>>;
    previewImage?: Maybe<Pick<Image, 'url'>>;
  };
...
type Media_Model3d_Fragment = {__typename: 'Model3d'} & Pick<
  ...
  'id' | 'mediaContentType' | 'alt'
> & {
    sources: Array<Pick<Model3dSource, 'mimeType' | 'url'>>;
    previewImage?: Maybe<Pick<Image, 'url'>>;
  };
...
type Media_Video_Fragment = {__typename: 'Video'} & Pick<
  ...
  'id' | 'mediaContentType' | 'alt'
> & {
    sources: Array<Pick<VideoSource, 'mimeType' | 'url'>>;
    previewImage?: Maybe<Pick<Image, 'url'>>;
  };
...
export type LayoutQuery = {
  shop: Pick<Shop, 'id' | 'name' | 'description'> & {
    ...
    brand?: Maybe<{logo?: Maybe<{image?: Maybe<Pick<Image, 'url'>>}>}>;
  };
  headerMenu?: Maybe<
    Pick<Menu, 'id'> & {
      items: Array<
...
export type ShopFragment = Pick<Shop, 'id' | 'name' | 'description'> & {
  primaryDomain: Pick<Domain, 'url'>;
  brand?: Maybe<{logo?: Maybe<{image?: Maybe<Pick<Image, 'url'>>}>}>;
};
...
> & {
  items: Array<
    Pick<MenuItem, 'id' | 'resourceId' | 'tags' | 'title' | 'type' | 'url'>
  >;
};

export type MenuFragment = Pick<Menu, 'id'> & {
  items: Array<
    Pick<MenuItem, 'id' | 'resourceId' | 'tags' | 'title' | 'type' | 'url'> & {
      items: Array<
        Pick<MenuItem, 'id' | 'resourceId' | 'tags' | 'title' | 'type' | 'url'>
...
export type CartQueryQuery = {
  cart?: Maybe<
    Pick<Cart, 'id' | 'checkoutUrl' | 'totalQuantity' | 'note'> & {
      buyerIdentity: Pick<
        CartBuyerIdentity,
      ...
      lines: {
        edges: Array<{
          node: Pick<CartLine, 'id' | 'quantity'> & {
            attributes: Array<Pick<Attribute, 'key' | 'value'>>;
            cost: {
              totalAmount: Pick<MoneyV2, 'amount' | 'currencyCode'>;
              amountPerQuantity: Pick<MoneyV2, 'amount' | 'currencyCode'>;
              compareAtAmountPerQuantity?: Maybe<
            ...
            > & {
              compareAtPrice?: Maybe<Pick<MoneyV2, 'currencyCode' | 'amount'>>;
              price: Pick<MoneyV2, 'currencyCode' | 'amount'>;
              image?: Maybe<
                Pick<Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
              >;
              product: Pick<Product, 'handle' | 'title' | 'id'>;
              selectedOptions: Array<Pick<SelectedOption, 'name' | 'value'>>;
            };
          };
        }>;
      ...
      cost: {
        subtotalAmount: Pick<MoneyV2, 'currencyCode' | 'amount'>;
        totalAmount: Pick<MoneyV2, 'currencyCode' | 'amount'>;
        totalDutyAmount?: Maybe<Pick<MoneyV2, 'currencyCode' | 'amount'>>;
        totalTaxAmount?: Maybe<Pick<MoneyV2, 'currencyCode' | 'amount'>>;
      };
      attributes: Array<Pick<Attribute, 'key' | 'value'>>;
      discountCodes: Array<Pick<CartDiscountCode, 'code'>>;
    }
  >;
};
...
> & {
  buyerIdentity: Pick<CartBuyerIdentity, 'countryCode' | 'email' | 'phone'> & {
    customer?: Maybe<
      Pick<Customer, 'id' | 'email' | 'firstName' | 'lastName' | 'displayName'>
    >;
  };
  lines: {
    edges: Array<{
...
export type MoneyFragmentFragment = Pick<MoneyV2, 'currencyCode' | 'amount'>;
...
export type GetShopPrimaryDomainQueryVariables = Exact<{[key: string]: never}>;

export type GetShopPrimaryDomainQuery = {
  shop: {primaryDomain: Pick<Domain, 'url'>};
};
...
> & {
  heading?: Maybe<Pick<Metafield, 'value'>>;
  byline?: Maybe<Pick<Metafield, 'value'>>;
  cta?: Maybe<Pick<Metafield, 'value'>>;
  spread?: Maybe<{
    reference?: Maybe<
...
export type SeoCollectionContentQueryVariables = Exact<{
  handle?: InputMaybe<Scalars['String']>;
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
}>;
...
export type SeoCollectionContentQuery = {
  hero?: Maybe<
    Pick<Collection, 'id' | 'handle' | 'title' | 'descriptionHtml'> & {
      heading?: Maybe<Pick<Metafield, 'value'>>;
      byline?: Maybe<Pick<Metafield, 'value'>>;
      cta?: Maybe<Pick<Metafield, 'value'>>;
      spread?: Maybe<{
...
export type HeroCollectionContentQueryVariables = Exact<{
  handle?: InputMaybe<Scalars['String']>;
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
}>;
...
export type HomepageFeaturedProductsQueryVariables = Exact<{
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
}>;
...
export type HomepageFeaturedProductsQuery = {
  products: {
    nodes: Array<
      Pick<Product, 'id' | 'title' | 'publishedAt' | 'handle' | 'vendor'> & {
        variants: {
          nodes: Array<
            Pick<ProductVariant, 'id'> & {
              image?: Maybe<
...
export type HomepageFeaturedCollectionsQueryVariables = Exact<{
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
}>;
...
export type CustomerAddressDeleteMutation = {
  customerAddressDelete?: Maybe<
    Pick<CustomerAddressDeletePayload, 'deletedCustomerAddressId'> & {
      customerUserErrors: Array<
        Pick<CustomerUserError, 'code' | 'field' | 'message'>
      >;
    }
...
export type CustomerAddressCreateMutation = {
  customerAddressCreate?: Maybe<{
    customerAddress?: Maybe<Pick<MailingAddress, 'id'>>;
    customerUserErrors: Array<
      Pick<CustomerUserError, 'code' | 'field' | 'message'>
    >;
  }>;
...
export type MoneyFragment = Pick<MoneyV2, 'amount' | 'currencyCode'>;
...
> & {
  image?: Maybe<
    Pick<Image, 'altText' | 'height' | 'id' | 'width'> & {src: Image['url']}
  >;
  price: Pick<MoneyV2, 'amount' | 'currencyCode'>;
  product: Pick<Product, 'handle'>;
};

export type LineItemFullFragment = Pick<OrderLineItem, 'title' | 'quantity'> & {
  discountAllocations: Array<{
    allocatedAmount: Pick<MoneyV2, 'amount' | 'currencyCode'>;
    discountApplication:
      | {
          value:
  ...
  originalTotalPrice: Pick<MoneyV2, 'amount' | 'currencyCode'>;
  discountedTotalPrice: Pick<MoneyV2, 'amount' | 'currencyCode'>;
  variant?: Maybe<
...
export type CustomerOrderQuery = {
  node?: Maybe<
    | (Pick<
      ...
      > & {
        totalTaxV2?: Maybe<Pick<MoneyV2, 'amount' | 'currencyCode'>>;
        totalPriceV2: Pick<MoneyV2, 'amount' | 'currencyCode'>;
        subtotalPriceV2?: Maybe<Pick<MoneyV2, 'amount' | 'currencyCode'>>;
        ...
        lineItems: {
          nodes: Array<
            Pick<OrderLineItem, 'title' | 'quantity'> & {
              discountAllocations: Array<{
                allocatedAmount: Pick<MoneyV2, 'amount' | 'currencyCode'>;
                discountApplication:
                  | {
              ...
              variant?: Maybe<
                Pick<ProductVariant, 'id' | 'sku' | 'title'> & {
                  image?: Maybe<
                    Pick<Image, 'altText' | 'height' | 'id' | 'width'> & {
                      src: Image['url'];
                    }
                  >;
                  price: Pick<MoneyV2, 'amount' | 'currencyCode'>;
...
export type CustomerCreateMutation = {
  customerCreate?: Maybe<{
    customer?: Maybe<Pick<Customer, 'id'>>;
    customerUserErrors: Array<
      Pick<CustomerUserError, 'code' | 'field' | 'message'>
    >;
  }>;
...
export type CustomerDetailsQuery = {
  customer?: Maybe<
    Pick<Customer, 'firstName' | 'lastName' | 'phone' | 'email'> & {
            ...
            lineItems: {
              edges: Array<{
                node: Pick<OrderLineItem, 'title'> & {
                  variant?: Maybe<{
                    image?: Maybe<
                      Pick<Image, 'url' | 'altText' | 'height' | 'width'>
                    >;
                  }>;
                };
              }>;
...
export type ApiAllProductsQueryVariables = Exact<{
  query?: InputMaybe<Scalars['String']>;
...
export type CartLinesFragmentFragment = Pick<Cart, 'id' | 'totalQuantity'>;
...
export type CartDiscountCodesUpdateMutation = {
  cartDiscountCodesUpdate?: Maybe<{
    cart?: Maybe<
      Pick<Cart, 'id'> & {discountCodes: Array<Pick<CartDiscountCode, 'code'>>}
    >;
    errors: Array<Pick<CartUserError, 'field' | 'message'>>;
  }>;
};
...
export type CollectionDetailsQuery = {
  collection?: Maybe<
    Pick<Collection, 'id' | 'handle' | 'title' | 'description'> & {
      seo: Pick<Seo, 'description' | 'title'>;
      image?: Maybe<Pick<Image, 'id' | 'url' | 'width' | 'height' | 'altText'>>;
      products: {
        filters: Array<
  ...
  >;
  collections: {edges: Array<{node: Pick<Collection, 'title' | 'handle'>}>};
};
...
export type CollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<Collection, 'id' | 'title' | 'description' | 'handle'> & {
        seo: Pick<Seo, 'description' | 'title'>;
        image?: Maybe<
...
export type FeaturedItemsQueryVariables = Exact<{
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
  pageBy?: InputMaybe<Scalars['Int']>;
}>;
...
export type ArticleDetailsQuery = {
  blog?: Maybe<{
    articleByHandle?: Maybe<
      Pick<Article, 'title' | 'contentHtml' | 'publishedAt'> & {
        author?: Maybe<Pick<ArticleAuthor, 'name'>>;
        image?: Maybe<
          Pick<Image, 'id' | 'altText' | 'url' | 'width' | 'height'>
        >;
        seo?: Maybe<Pick<Seo, 'description' | 'title'>>;
      }
    >;
  }>;
};
...
> & {
  author?: Maybe<Pick<ArticleAuthor, 'name'>>;
  image?: Maybe<Pick<Image, 'id' | 'altText' | 'url' | 'width' | 'height'>>;
};
...
export type PoliciesHandleQueryVariables = Exact<{
  language?: InputMaybe<LanguageCode>;
  privacyPolicy: Scalars['Boolean'];
  shippingPolicy: Scalars['Boolean'];
...
export type PoliciesHandleQuery = {
  shop: {
    privacyPolicy?: Maybe<
      Pick<ShopPolicy, 'body' | 'handle' | 'id' | 'title' | 'url'>
    >;
    shippingPolicy?: Maybe<
      Pick<ShopPolicy, 'body' | 'handle' | 'id' | 'title' | 'url'>
    >;
...
export type PolicyIndexFragment = Pick<ShopPolicy, 'id' | 'title' | 'handle'>;

export type PoliciesIndexQueryVariables = Exact<{[key: string]: never}>;

export type PoliciesIndexQuery = {
  shop: {
    privacyPolicy?: Maybe<Pick<ShopPolicy, 'id' | 'title' | 'handle'>>;
    shippingPolicy?: Maybe<Pick<ShopPolicy, 'id' | 'title' | 'handle'>>;
    termsOfService?: Maybe<Pick<ShopPolicy, 'id' | 'title' | 'handle'>>;
    refundPolicy?: Maybe<Pick<ShopPolicy, 'id' | 'title' | 'handle'>>;
    subscriptionPolicy?: Maybe<
      Pick<ShopPolicyWithDefault, 'id' | 'title' | 'handle'>
    >;
  };
};
...
> & {
  selectedOptions: Array<Pick<SelectedOption, 'name' | 'value'>>;
  image?: Maybe<Pick<Image, 'id' | 'url' | 'altText' | 'width' | 'height'>>;
  price: Pick<MoneyV2, 'amount' | 'currencyCode'>;
  compareAtPrice?: Maybe<Pick<MoneyV2, 'amount' | 'currencyCode'>>;
...
export type ProductQuery = {
  ...
  shop: Pick<Shop, 'name'> & {
    primaryDomain: Pick<Domain, 'url'>;
    shippingPolicy?: Maybe<Pick<ShopPolicy, 'body' | 'handle'>>;
    refundPolicy?: Maybe<Pick<ShopPolicy, 'body' | 'handle'>>;
  };
};
...
export type PaginatedProductsSearchQueryVariables = Exact<{
  country?: InputMaybe<CountryCode>;
  endCursor?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  language?: InputMaybe<LanguageCode>;
...
export type SitemapsQuery = {
  ...
  pages: {nodes: Array<Pick<Page, 'updatedAt' | 'handle' | 'onlineStoreUrl'>>};
};
