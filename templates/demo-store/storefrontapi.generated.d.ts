  ...
  variants: {
    nodes: Array<
      Pick<StorefrontAPI.ProductVariant, 'id'> & {
        image?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Image, 'altText' | 'width' | 'height'> & {
            url: StorefrontAPI.Image['transformedSrc'];
          }
        >;
...
export type FeaturedItemsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  productsCount?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']>;
  collectionsCount?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']>;
}>;
