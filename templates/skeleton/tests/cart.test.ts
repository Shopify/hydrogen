...
type StorefrontQueryFunction<RawGqlString extends string> = (
  query: RawGqlString,
) => Promise<
  RawGqlString extends keyof StorefrontQueries
    ? // Known query
      StorefrontQueries[RawGqlString]['return']
    : // Unknown query, fallback to any
      any
>;

function storefrontQuery<RawGqlString extends string>(
  query: RawGqlString,
): Promise<
  RawGqlString extends keyof StorefrontQueries
    ? // Known query
...
export const storefront = {
  query: implementation as StorefrontQueryFunction,
};
