var privacyBanner = (function (n) {
  ...
  function Kn(n, e, t) {
    var o = e.granular_consent,
      ...
      apiDomain = o.checkoutRootDomain || window.location.host,
      apiProtocol = /^localhost(:|$)/.test(apiDomain) ? 'http:' : 'https:',
    ...
    console.log('WOT', {apiProtocol, apiDomain, o});
    return fetch(
      apiProtocol.concat(
        '//',
        apiDomain,
        ...
        var a,
          ...
          m =
            null !==
              ...
              ? a
              : '';
        console.log('checkoutRootDomain', u, 'storefrontRootDomain', d);
        return (
          p &&
            (function (n) {
              var e;
            ...
            return o(this, function (o) {
              switch (o.label) {
                case 0:
                  ...
                  return (
                    (t = this.domain
                      ? (this.domain.includes('localhost')
                          ? 'http://'
                          : 'https://'
                        ).concat(this.domain)
                      : ''),
