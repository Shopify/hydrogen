...
export type StoreCreditBalanceQueryVariables = CustomerAccountAPI.Exact<{
  [key: string]: never;
}>;

export type StoreCreditBalanceQuery = {
  customer: {
    storeCreditAccounts: {
      nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query StoreCreditBalance {\n    customer {\n      storeCreditAccounts(first: 10) {\n        nodes {\n          id\n          balance {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    return: StoreCreditBalanceQuery;
    variables: StoreCreditBalanceQueryVariables;
  };
}
